...
const initialState = {
  ...
  subcategories: [],
  tasks: [],
  taskerAvailabilities: [],
  taskerLocations: [],
  taskerPaymentAccounts: [],
  taskerProfiles: [],
  taskerSkills: [],
  taskerWallets: [],
  taskLocations: [],
...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_BUSINESSPHOTO_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        businessPhotos: [...state.businessPhotos, action.response]
      })
    case types.API_V1_BUSINESSPHOTO_LIST_FAILED:
      return Object.assign({}, state, {
        bourkhaAPI: [...state.bourkhaAPI, action.response]
      })
    ...
    case types.API_V1_BUSINESSPHOTO_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        businessPhotos: state.businessPhotos.map(record =>
    ...
    case types.API_V1_CUSTOMERLOCATION_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        customerLocations: [...state.customerLocations, action.response]
      })
    ...
    case types.API_V1_CUSTOMERLOCATION_READ_SUCCEEDED:
      return Object.assign({}, state, {
        customerLocations: [
          ...state.customerLocations.filter(
            record => record.id !== action.response.id
          ),
          action.response
        ]
    ...
    case types.API_V1_CUSTOMERLOCATION_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        customerLocations: state.customerLocations.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_CUSTOMERPROFILE_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        customerProfiles: [...state.customerProfiles, action.response]
      })
    ...
    case types.API_V1_CUSTOMERPROFILE_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        customerProfiles: state.customerProfiles.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_CUSTOMERWALLET_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        customerWallets: [...state.customerWallets, action.response]
      })
    ...
    case types.API_V1_CUSTOMERWALLET_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        customerWallets: state.customerWallets.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_INVITECODE_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        inviteCodes: [...state.inviteCodes, action.response]
      })
    ...
    case types.API_V1_INVITECODE_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        inviteCodes: state.inviteCodes.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_MAPLOCATION_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        mapLocations: [...state.mapLocations, action.response]
      })
    ...
    case types.API_V1_MAPLOCATION_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        mapLocations: state.mapLocations.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_NOTIFICATION_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        notifications: [...state.notifications, action.response]
      })
    ...
    case types.API_V1_PAYMENTTRANSACTION_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        paymentTransactions: [...state.paymentTransactions, action.response]
      })
    ...
    case types.API_V1_PAYMENTTRANSACTION_READ_SUCCEEDED:
      return Object.assign({}, state, {
        paymentTransactions: [
          ...state.paymentTransactions.filter(
            record => record.id !== action.response.id
          ),
          action.response
        ]
    ...
    case types.API_V1_PAYMENTTRANSACTION_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        paymentTransactions: state.paymentTransactions.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_RATING_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        ratings: [...state.ratings, action.response]
      })
    ...
    case types.API_V1_RATING_READ_SUCCEEDED:
      return Object.assign({}, state, {
        ratings: [
          ...state.ratings.filter(record => record.id !== action.response.id),
          action.response
        ]
      })
    ...
    case types.API_V1_RATING_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        ratings: state.ratings.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_SUBCATEGORY_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        subcategories: state.subcategories.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_TASK_READ_SUCCEEDED:
      return Object.assign({}, state, {
        tasks: [
          ...state.tasks.filter(record => record.id !== action.response.id),
          action.response
        ]
      })
    ...
    case types.API_V1_TASKERAVAILABILITY_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        taskerAvailabilities: [...state.taskerAvailabilities, action.response]
      })
    ...
    case types.API_V1_TASKERAVAILABILITY_READ_SUCCEEDED:
      return Object.assign({}, state, {
        taskerAvailabilities: [
          ...state.taskerAvailabilities.filter(
            record => record.id !== action.response.id
          ),
          action.response
        ]
    ...
    case types.API_V1_TASKERAVAILABILITY_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        taskerAvailabilities: state.taskerAvailabilities.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_TASKERLOCATION_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        taskerLocations: [...state.taskerLocations, action.response]
      })
    ...
    case types.API_V1_TASKERLOCATION_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        taskerLocations: state.taskerLocations.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_TASKERPAYMENTACCOUNT_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        taskerPaymentAccounts: [...state.taskerPaymentAccounts, action.response]
      })
    ...
    case types.API_V1_TASKERPAYMENTACCOUNT_READ_SUCCEEDED:
      return Object.assign({}, state, {
        taskerPaymentAccounts: [
          ...state.taskerPaymentAccounts.filter(
            record => record.id !== action.response.id
          ),
          action.response
        ]
    ...
    case types.API_V1_TASKERPAYMENTACCOUNT_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        taskerPaymentAccounts: state.taskerPaymentAccounts.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_TASKERPROFILE_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        taskerProfiles: [...state.taskerProfiles, action.response]
      })
    ...
    case types.API_V1_TASKERPROFILE_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        taskerProfiles: state.taskerProfiles.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_TASKERSKILL_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        taskerSkills: [...state.taskerSkills, action.response]
      })
    ...
    case types.API_V1_TASKERSKILL_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        taskerSkills: state.taskerSkills.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_TASKERWALLET_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        taskerWallets: [...state.taskerWallets, action.response]
      })
    ...
    case types.API_V1_TASKERWALLET_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        taskerWallets: state.taskerWallets.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_TASKLOCATION_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        taskLocations: [...state.taskLocations, action.response]
      })
    ...
    case types.API_V1_TASKLOCATION_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        taskLocations: state.taskLocations.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_TASKTRANSACTION_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        taskTransactions: [...state.taskTransactions, action.response]
      })
    ...
    case types.API_V1_TASKTRANSACTION_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        taskTransactions: state.taskTransactions.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    ...
    case types.API_V1_TIMESLOT_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        timeslots: [...state.timeslots, action.response]
      })
    ...
    case types.API_V1_TIMESLOT_READ_SUCCEEDED:
      return Object.assign({}, state, {
        timeslots: [
          ...state.timeslots.filter(record => record.id !== action.response.id),
          action.response
        ]
      })
    ...
    case types.API_V1_TIMESLOT_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        timeslots: state.timeslots.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
